...
import { FaGoogle, FaTwitter, FaDiscord, FaInstagram } from 'react-icons/fa'
...
// 👉 You should update these to match your actual OAuth endpoints
const oauthUrls: Record<string, string> = {
  google: `https://accounts.google.com/o/oauth2/v2/auth?client_id=939387837885-2t69t118m5blfco7o73k0tgjql7bmfd0.apps.googleusercontent.com&redirect_uri=${encodeURIComponent("http://localhost:3000/oauth-callback.html")}&response_type=code&scope=openid%20email%20profile&access_type=offline&prompt=consent&state=google123`,

  twitter: 'http://localhost:5000/api/auth/twitter?popup=true',
  discord: 'http://localhost:5000/api/auth/discord?popup=true',
